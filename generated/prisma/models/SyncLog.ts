...
export type SyncLogWhereInput = {
  ...
  sync_id?: Prisma.IntFilter<"SyncLog"> | number
  user_id?: Prisma.IntFilter<"SyncLog"> | number
  table_name?: Prisma.StringFilter<"SyncLog"> | string
  record_id?: Prisma.IntFilter<"SyncLog"> | number
  last_updated?: Prisma.DateTimeFilter<"SyncLog"> | Date | string
  operation?: Prisma.EnumSyncOperationFilter<"SyncLog"> | $Enums.SyncOperation
  is_synced?: Prisma.BoolFilter<"SyncLog"> | boolean
  user?: Prisma.XOR<Prisma.UserScalarRelationFilter, Prisma.UserWhereInput>
}

export type SyncLogOrderByWithRelationInput = {
  sync_id?: Prisma.SortOrder
  user_id?: Prisma.SortOrder
  table_name?: Prisma.SortOrder
  record_id?: Prisma.SortOrder
  last_updated?: Prisma.SortOrder
  operation?: Prisma.SortOrder
  is_synced?: Prisma.SortOrder
...
export type SyncLogScalarWhereWithAggregatesInput = {
  ...
  sync_id?: Prisma.IntWithAggregatesFilter<"SyncLog"> | number
  user_id?: Prisma.IntWithAggregatesFilter<"SyncLog"> | number
  table_name?: Prisma.StringWithAggregatesFilter<"SyncLog"> | string
  record_id?: Prisma.IntWithAggregatesFilter<"SyncLog"> | number
  last_updated?: Prisma.DateTimeWithAggregatesFilter<"SyncLog"> | Date | string
  operation?: Prisma.EnumSyncOperationWithAggregatesFilter<"SyncLog"> | $Enums.SyncOperation
  is_synced?: Prisma.BoolWithAggregatesFilter<"SyncLog"> | boolean
}
...
export type SyncLogCreateInput = {
  ...
  operation: $Enums.SyncOperation
  is_synced?: boolean
  user: Prisma.UserCreateNestedOneWithoutSync_logsInput
}
...
export type SyncLogUpdateInput = {
  ...
  is_synced?: Prisma.BoolFieldUpdateOperationsInput | boolean
  user?: Prisma.UserUpdateOneRequiredWithoutSync_logsNestedInput
}

export type SyncLogUncheckedUpdateInput = {
  sync_id?: Prisma.IntFieldUpdateOperationsInput | number
...
export type SyncLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"sync_id" | "user_id" | "table_name" | "record_id" | "last_updated" | "operation" | "is_synced", ExtArgs["result"]["syncLog"]>
...
export interface SyncLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `sync_id`
   * const syncLogWithSync_idOnly = await prisma.syncLog.findMany({ select: { sync_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many SyncLogs and only return the `sync_id`
   * const syncLogWithSync_idOnly = await prisma.syncLog.createManyAndReturn({
   *   select: { sync_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more SyncLogs and only return the `sync_id`
   * const syncLogWithSync_idOnly = await prisma.syncLog.updateManyAndReturn({
   *   select: { sync_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SyncLogFieldRefs {
  readonly sync_id: Prisma.FieldRef<"SyncLog", 'Int'>
  readonly user_id: Prisma.FieldRef<"SyncLog", 'Int'>
  readonly table_name: Prisma.FieldRef<"SyncLog", 'String'>
  readonly record_id: Prisma.FieldRef<"SyncLog", 'Int'>
  readonly last_updated: Prisma.FieldRef<"SyncLog", 'DateTime'>
  readonly operation: Prisma.FieldRef<"SyncLog", 'SyncOperation'>
  readonly is_synced: Prisma.FieldRef<"SyncLog", 'Boolean'>
}
